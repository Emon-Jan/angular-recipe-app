...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    new Recipe(
      ...
      "https://res.cloudinary.com/hellofresh/image/upload/" +
        "f_auto,fl_lossy,q_80,w_auto:100:1280/v1/hellofresh_s3/image/chicken-sausage-pizzas-13655da0.jpg",
      [
        new Ingredients("Sweet Italian Chicken Sausage", 9),
        new Ingredients("Mozzarella Cheese", 1)
      ]
    ),
    new Recipe(
      ...
      "https://res.cloudinary.com/hellofresh/image/upload/" +
        "f_auto,fl_lossy,q_80,w_auto:100:1280/v1/hellofresh_s3/image/5a8f0f25ae08b52e8f500a82-258967c5.jpg",
      [
        new Ingredients("New York Strip Steak", 12),
        new Ingredients("Fingerling Potatoes", 12)
      ]
    ),
    new Recipe(
      ...
      "https://res.cloudinary.com/hellofresh/image/upload/" +
        "f_auto,fl_lossy,q_80,w_auto:100:1280/v1/hellofresh_s3/image/5a8f100aae08b52f3c24a0b2-516fcaf8.jpg",
      [
        new Ingredients("Chicken Stock Concentrate", 2),
        new Ingredients("Italian Chicken Sausage", 12)
      ]
    ),
    new Recipe(
      ...
      "https://res.cloudinary.com/hellofresh/image/upload/" +
        "f_auto,fl_lossy,q_80,w_auto:100:1280/v1/hellofresh_s3/image/5a8f0fcbae08b52f161b5832-033c9a4a.jpg",
